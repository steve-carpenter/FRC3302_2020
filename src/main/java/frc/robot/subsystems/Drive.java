...
import frc.robot.enums.DriveType;
...
public class Drive extends SubsystemBase {
    ...
    private SendableChooser<DriveType> chooser = new SendableChooser<DriveType>();
    ...
    public Drive() {
        ...
        leftSide = new Spark(RobotMap.DRIVETRAIN_LEFT_FRONT_SPARK);
        rightSide = new Spark(RobotMap.DRIVETRAIN_RIGHT_BACK_SPARK);

        //leftSide = new SpeedControllerGroup(leftFront, leftRear);
        //rightSide = new SpeedControllerGroup(rightFront, rightRear);

        //cha = new DifferentialDrive(leftFront, rightFront);
        //rightSide = new DifferentialDrive(leftRear, rightRear);
    ...
    public void tankDrive(double leftSpeed, double rightSpeed) {
        ...
        //rightSide.tankDrive(leftSpeed, rightSpeed);
    }
    ...
    public double getRotationsLeft() {
      ...
      private void commandDropDown(){
        chooser.addOption("Arcade Drive", DriveType.ARCADE);
        chooser.setDefaultOption("Tank Drive", DriveType.TANK);
        SmartDashboard.putData("Drive Mode", chooser);
      }
  
      public DriveType getChooserType(){
