...
public class Drive extends SubsystemBase {
    ...
    public Drive() {
        ...
        leftRear = new Spark(RobotMap.DRIVETRAIN_LEFT_BACK_SPARK);
        rightFront = new Spark(RobotMap.DRIVETRAIN_RIGHT_FRONT_SPARK);
        rightRear = new Spark(RobotMap.DRIVETRAIN_RIGHT_BACK_SPARK);
